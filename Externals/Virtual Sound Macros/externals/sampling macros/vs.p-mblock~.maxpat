{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 155.0, 44.0, 546.0, 372.0 ],
		"bglocked" : 0,
		"defrect" : [ 155.0, 44.0, 546.0, 372.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 95.0, 44.0, 399.0, 209.0 ],
						"bglocked" : 0,
						"defrect" : [ 95.0, 44.0, 399.0, 209.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "reverse mode:\n0: esecuzione da cue a (cue - durata)\n1: esecuzione da (cue + durata) a cue\ndefault 0",
									"linecount" : 4,
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 0,
									"fontsize" : 12.0,
									"patching_rect" : [ 181.0, 50.0, 214.0, 62.0 ],
									"id" : "obj-5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 140.0, 61.0, 25.0, 25.0 ],
									"id" : "obj-1",
									"comment" : ""
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 144.0, 54.0, 20.0 ],
									"id" : "obj-17"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 57.0, 91.0, 76.5, 20.0 ],
									"id" : "obj-33"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 57.0, 66.0, 32.5, 20.0 ],
									"id" : "obj-32"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 15.0, 35.0, 32.5, 20.0 ],
									"id" : "obj-31"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.0, 168.0, 25.0, 25.0 ],
									"id" : "obj-22",
									"comment" : ""
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 488.0, 77.0, 44.0, 20.0 ],
					"id" : "obj-16"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 276.0, 376.0, 203.0, 32.0 ],
					"id" : "obj-47"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 354.0, 349.0, 65.0, 21.0 ],
					"id" : "obj-48"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 2.0, 376.0, 272.0, 32.0 ],
					"id" : "obj-49"
				}
...
, 			{
				"box" : 				{
					...
					"handoff" : "",
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 123.0, 349.0, 130.0, 20.0 ],
					"id" : "obj-74"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1.0, 349.0, 419.0, 20.0 ],
					"id" : "obj-7",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 35.0, 323.0, 44.0, 20.0 ],
					"id" : "obj-4",
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "list: speed, cue, duration, fadein, fadeout, amp, reverse mode ",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 39.0, 30.0, 348.0, 20.0 ],
					"id" : "obj-2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 4.0, 56.0, 531.0, 20.0 ],
					"id" : "obj-51"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 440.166656, 278.0, 84.0, 278.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.545098, 0.501961, 0.070588, 1.0 ],
					"midpoints" : [ 525.5, 102.0, 184.5, 102.0 ]
				}
