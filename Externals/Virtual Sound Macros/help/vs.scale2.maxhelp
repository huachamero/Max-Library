{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 27.0, 44.0, 510.0, 421.0 ],
		"bglocked" : 0,
		"defrect" : [ 27.0, 44.0, 510.0, 421.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 284.0, 427.0, 203.0, 32.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"patching_rect" : [ 362.0, 400.0, 65.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 10.0, 427.0, 272.0, 32.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"patching_rect" : [ 131.0, 400.0, 130.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 400.0, 419.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 92.0, 32.0, 27.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 319.0, 128.0, 178.0, 75.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 69.0, 124.0, 76.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 92.0, 25.0, 27.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 95.0, 109.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 148.0, 124.0, 166.5, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "vs.scale2 0 127 0 127",
					"outlettype" : [ "" ],
					"id" : "obj-1",
					"fontsize" : 12.0,
					"numinlets" : 6,
					"numoutlets" : 1,
					"patching_rect" : [ 188.0, 182.0, 127.0, 20.0 ],
					"fontname" : "Arial"
				}
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Simile a vs.scale, ma accetta anche esponenti negativi",
									"id" : "obj-26",
									"fontsize" : 12.0,
									"numinlets" : 1,
									"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Similar to vs.scale but also accepts negative exponents",
					"id" : "obj-43",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
