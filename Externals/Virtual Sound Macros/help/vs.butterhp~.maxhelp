{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 11.0, 48.0, 513.0, 376.0 ],
		"bglocked" : 0,
		"defrect" : [ 11.0, 48.0, 513.0, 376.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 331.0, 137.0, 150.0, 48.0 ],
					"id" : "obj-14",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 283.0, 372.0, 203.0, 32.0 ],
					"id" : "obj-4",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 343.0, 345.0, 65.0, 21.0 ],
					"id" : "obj-7",
					"numinlets" : 1,
					"numoutlets" : 4
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 9.0, 372.0, 272.0, 32.0 ],
					"id" : "obj-9",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"handoff" : "",
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 130.0, 345.0, 130.0, 20.0 ],
					"id" : "obj-10",
					"numinlets" : 1,
					"numoutlets" : 4
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 8.0, 345.0, 419.0, 20.0 ],
					"id" : "obj-12",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 216.0, 111.0, 58.0, 20.0 ],
					"id" : "obj-5",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "vs.butterhp~ 10000",
					"outlettype" : [ "signal" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 121.0, 151.0, 114.0, 20.0 ],
					"id" : "obj-1",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"fontsize" : 11.595187,
					"patching_rect" : [ 212.0, 94.0, 61.0, 20.0 ],
					"id" : "obj-18",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Filtro passa alto di Butterworth del secondo ordine",
									"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
									"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "Second Order Butterworth highpass Filter",
					"frgb" : [ 0.2, 0.2, 0.2, 1.0 ],
					"fontsize" : 12.754705,
