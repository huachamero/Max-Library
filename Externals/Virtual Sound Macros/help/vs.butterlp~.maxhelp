{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 11.0, 48.0, 506.0, 377.0 ],
		"bglocked" : 0,
		"defrect" : [ 11.0, 48.0, 506.0, 377.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 331.0, 138.0, 150.0, 48.0 ],
					"id" : "obj-14",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 283.0, 373.0, 203.0, 32.0 ],
					"id" : "obj-4",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 343.0, 346.0, 65.0, 21.0 ],
					"id" : "obj-7",
					"numinlets" : 1,
					"numoutlets" : 4
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 9.0, 373.0, 272.0, 32.0 ],
					"id" : "obj-9",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"handoff" : "",
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 130.0, 346.0, 130.0, 20.0 ],
					"id" : "obj-10",
					"numinlets" : 1,
					"numoutlets" : 4
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 8.0, 346.0, 419.0, 20.0 ],
					"id" : "obj-12",
					"numinlets" : 1,
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Filtro passa basso di Butterworth del secondo ordine",
									"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
									"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "Second Order Butterworth lowpass Filter",
					"frgb" : [ 0.2, 0.2, 0.2, 1.0 ],
					"fontsize" : 12.754705,
