{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 19.0, 44.0, 509.0, 383.0 ],
		"bglocked" : 0,
		"defrect" : [ 19.0, 44.0, 509.0, 383.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 288.0, 380.0, 203.0, 32.0 ],
					"id" : "obj-9"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 366.0, 353.0, 65.0, 21.0 ],
					"id" : "obj-12",
					"handoff" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 14.0, 380.0, 272.0, 32.0 ],
					"id" : "obj-13"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 135.0, 353.0, 130.0, 20.0 ],
					"id" : "obj-14",
					"handoff" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 13.0, 353.0, 419.0, 20.0 ],
					"id" : "obj-15",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 234.0, 111.0, 50.0, 20.0 ],
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 11.595187,
					"patching_rect" : [ 234.0, 94.0, 38.0, 20.0 ],
					"id" : "obj-7"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 178.0, 111.0, 50.0, 20.0 ],
					"id" : "obj-5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 189.0, 173.0, 163.0, 20.0 ],
					"id" : "obj-6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 11.595187,
					"patching_rect" : [ 174.0, 94.0, 61.0, 20.0 ],
					"id" : "obj-18"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 11.595187,
					"patching_rect" : [ 291.0, 94.0, 38.0, 20.0 ],
					"id" : "obj-19"
				}
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Filtro highshelf del secondo ordine",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0,
									"fontsize" : 12.0,
									"patching_rect" : [ 60.0, 42.0, 206.0, 20.0 ],
									"id" : "obj-26"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "Second Order highshelf Filter",
					"frgb" : [ 0.2, 0.2, 0.2, 1.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
