{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 27.0, 48.0, 508.0, 417.0 ],
		"bglocked" : 0,
		"defrect" : [ 27.0, 48.0, 508.0, 417.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 286.0, 421.0, 203.0, 32.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"patching_rect" : [ 364.0, 394.0, 65.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 12.0, 421.0, 272.0, 32.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"patching_rect" : [ 133.0, 394.0, 130.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 394.0, 419.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 191.0, 76.0, 34.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 250.0, 198.0, 49.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 179.0, 198.0, 66.0, 20.0 ],
					"fontname" : "Arial"
				}
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Distorce un suono in ingresso: ispirato alla funzione distort di Supercollider 2",
									"linecount" : 2,
									"id" : "obj-26",
									"fontsize" : 12.0,
									"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Distortion of the input sound: inspired by Supercollider 2 distort function",
					"id" : "obj-43",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
