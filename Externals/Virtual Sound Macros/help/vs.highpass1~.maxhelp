{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 19.0, 44.0, 509.0, 376.0 ],
		"bglocked" : 0,
		"defrect" : [ 19.0, 44.0, 509.0, 376.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 289.0, 373.0, 203.0, 32.0 ],
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 367.0, 346.0, 65.0, 21.0 ],
					"id" : "obj-7",
					"handoff" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 15.0, 373.0, 272.0, 32.0 ],
					"id" : "obj-8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 136.0, 346.0, 130.0, 20.0 ],
					"id" : "obj-9",
					"handoff" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 14.0, 346.0, 419.0, 20.0 ],
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 242.0, 139.0, 97.0, 34.0 ],
					"id" : "obj-10"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "vs.highpass1~ 5000",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 121.0, 152.0, 118.0, 20.0 ],
					"id" : "obj-1"
				}
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Filtro passa alto del primo ordine",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 0,
									"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "First Order highpass Filter",
					"frgb" : [ 0.2, 0.2, 0.2, 1.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
