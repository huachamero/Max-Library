{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 11.0, 48.0, 510.0, 376.0 ],
		"bglocked" : 0,
		"defrect" : [ 11.0, 48.0, 510.0, 376.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 338.0, 144.0, 150.0, 48.0 ],
					"id" : "obj-14",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 290.0, 379.0, 203.0, 32.0 ],
					"id" : "obj-4",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 350.0, 352.0, 65.0, 21.0 ],
					"id" : "obj-7",
					"numinlets" : 1,
					"numoutlets" : 4
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 16.0, 379.0, 272.0, 32.0 ],
					"id" : "obj-9",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"handoff" : "",
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 137.0, 352.0, 130.0, 20.0 ],
					"id" : "obj-10",
					"numinlets" : 1,
					"numoutlets" : 4
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 15.0, 352.0, 419.0, 20.0 ],
					"id" : "obj-12",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 121.0, 111.0, 62.0, 20.0 ],
					"id" : "obj-2",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Filtro elimina banda di Butterworth del secondo ordine",
									"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
									"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "Second Order Butterworth band reject Filter",
					"frgb" : [ 0.2, 0.2, 0.2, 1.0 ],
					"fontsize" : 12.754705,
